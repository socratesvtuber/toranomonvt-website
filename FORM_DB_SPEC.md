...
|-----|---------------|---------------------------|-----|------|------|
| 1 | `name_select` | あなたの名前をプルダウンから選択して下さい。 | 文字列 | 必須 | ※ここをミスるとデータが破壊されるので絶対間違えないで下さい！ |
| 2 | `sns_link` | SNS リンク | 文字列 | - | Twitter, YouTube 等へのリンク |
...
| 16 | `official_hashtag` | 公式ハッシュタグ | 文字列 | - | 例：#虎ノ門 VT |
...
| 27 | `public_flag` | 公開可否フラグ | 選択 | **必須** | 「公開」「非公開」から選択 |
